!function(e, t) {
    ...
    return function(r) {
        ...
        var h = function() {
          ...
          , g = function() {
            ...
            return (e.prototype = new Error).name = "NotImplementedException",
            e.constructor = e
        }()
          , v = function() {
            function e(e, t) {
            ...
            return (e.prototype = new Error).name = "MissingDataException",
            e.constructor = e
        }()
          , b = function() {
            function e(e) {
            ...
            return (e.prototype = new Error).name = "XRefParseException",
            e.constructor = e
        }()
          , _ = function() {
            function e(e) {
            ...
            return (e.prototype = new Error).name = "FormatError",
            e.constructor = e
        }()
          , y = function() {
            function e(e) {
        ...
        var P = function() {
            ...
            s.intersect = function(e, t) {
                ...
                var n = [e[0], e[2], t[0], t[2]].sort(r)
                  ...
                  , a = [];
                return e = s.normalizeRect(e),
                t = s.normalizeRect(t),
                (n[0] === e[0] && n[1] === t[0] || n[0] === t[0] && n[1] === e[0]) && (a[0] = n[1],
                a[2] = n[2],
                (i[0] === e[1] && i[1] === t[1] || i[0] === t[1] && i[1] === e[1]) && (a[1] = i[1],
                a[3] = i[2],
                a))
            }
            ,
          ...
          , C = function() {
            function n(e, t, r, n, i, a) {
                ...
                this.offsetX = n,
                this.offsetY = i;
                var s, o, l, c, u, h, d, f, p = (e[2] + e[0]) / 2, m = (e[3] + e[1]) / 2;
                ...
                a && (l = -l,
                c = -c),
                0 === s ? (u = Math.abs(m - e[1]) * t + n,
                h = Math.abs(p - e[0]) * t + i,
                d = Math.abs(e[3] - e[1]) * t,
                f = Math.abs(e[2] - e[0]) * t) : (u = Math.abs(p - e[0]) * t + n,
        ...
        var T, E = function() {
            ...
            return e.prototype = {
                time: function(e) {
                    this.enabled && (e in this.started && o("Timer is already running for " + e),
                    this.started[e] = Date.now())
                },
                timeEnd: function(e) {
                    this.enabled && (e in this.started || o("Timer has not been started for " + e),
                    this.times.push({
                        name: e,
        ...
        }, L = (T = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
        function(e, t) {
        ...
        function N(e, t, o) {
            ...
            this._onComObjOnMessage = function(e) {
                ...
                if (t.targetName === l.sourceName)
                    if (t.stream)
                        l._processStreamMessage(t);
                    else if (t.isReply) {
                        var r = t.callbackId;
                        if (!(t.callbackId in c))
                            throw new Error("Cannot resolve callback " + r);
                        var n = c[r];
                        delete c[r],
                        "error"in t ? n.reject(O(t.error)) : n.resolve(t.data)
                    } else {
                        if (!(t.action in u))
                        ...
                        if (t.callbackId) {
                            ...
                            t.streamId ? l._createStreamSink(t) : i[0].call(i[1], t.data)
                    }
            }
            ,
        ...
        N.prototype = {
            ...
            sendWithStream: function(r, n, e, t) {
                ...
                return new l.ReadableStream({
                    ...
                    pull: function(e) {
                        var t = x();
                        return i.streamControllers[a].pullCall = t,
                        i.postMessage({
                            sourceName: s,
                            targetName: o,
                            stream: "pull",
                    ...
                    cancel: function(e) {
                        var t = x();
                        return i.streamControllers[a].cancelCall = t,
            ...
            _createStreamSink: function(e) {
                  ...
                  , u = {
                    enqueue: function(e) {
                        ...
                        if (!this.isCancelled) {
                            ...
                            this.desiredSize -= t,
                            0 < n && this.desiredSize <= 0 && (this.sinkCapability = x(),
                ...
                D(r[0], [e.data, u], r[1]).then(function() {
                    a({
            ...
            _processStreamMessage: function(e) {
                var i = this
                  ...
                  , r = function() {
                    Promise.all([i.streamControllers[e.streamId].startCall, i.streamControllers[e.streamId].pullCall, i.streamControllers[e.streamId].cancelCall].map(function(e) {
                ...
                case "pull":
                    ...
                    D(this.streamSinks[e.streamId].onPull).then(function() {
                        t({
                            stream: "pull_complete",
                            success: !0
                        })
                    ...
                    break;
                case "enqueue":
                    u(this.streamControllers[e.streamId], "enqueue should have stream controller"),
                    this.streamControllers[e.streamId].isClosed || this.streamControllers[e.streamId].controller.enqueue(e.chunk);
                    break;
                case "close":
                    if (u(this.streamControllers[e.streamId], "close should have stream controller"),
                    ...
                    break;
                case "error":
                    u(this.streamControllers[e.streamId], "error should have stream controller"),
                    this.streamControllers[e.streamId].controller.error(O(e.reason)),
                    r();
                    break;
                case "cancel_complete":
                    F(this.streamControllers[e.streamId].cancelCall, e.success, O(e.reason)),
                    r();
                    break;
                case "cancel":
                    if (!this.streamSinks[e.streamId])
                        break;
                    D(this.streamSinks[e.streamId].onCancel, [O(e.reason)]).then(function() {
                        t({
    ...
    , function(e, t, r) {
        ...
        var i = "noopener noreferrer nofollow"
          ...
          , l = function() {
            ...
            return n(a, [{
                ...
                value: function(e) {
                    var a = this
                      , s = e.name;
                    return s ? new Promise(function(t, r) {
                        ...
                        i.onreadystatechange = function() {
                            if (i.readyState === XMLHttpRequest.DONE) {
                                if (200 === i.status || 0 === i.status) {
                                    var e = void 0;
                                    if (a.isCompressed && i.response ? e = new Uint8Array(i.response) : !a.isCompressed && i.responseText && (e = (0,
                                    o.stringToBytes)(i.responseText)),
                                    e)
                                        return void t({
                                            cMapData: e,
                                            compressionType: a.isCompressed ? o.CMapCompressionType.BINARY : o.CMapCompressionType.NONE
                                        })
                                }
          ...
          , c = function() {
            ...
            function e() {}
            return e.getProp = function(e, t) {
                if (1 === arguments.length && "string" == typeof l[e])
                    return l[e];
                var r, n, i = (t = t || document.documentElement).style;
                if ("string" == typeof i[e])
                    return l[e] = e;
                n = e.charAt(0).toUpperCase() + e.slice(1);
                for (var a = 0, s = o.length; a < s; a++)
                    if ("string" == typeof i[r = o[a] + n])
                        return l[e] = r;
          ...
          , u = function() {
            ...
            return (e.prototype = new Error).name = "RenderingCancelledException",
            e.constructor = e
        }()
          , h = {
            NONE: 0,
        ...
        t.addLinkAttributes = function(e, t) {
            ...
            o.removeNullCharacters)(r) : "",
            r) {
                var n = t.target;
                void 0 === n && (n = f("externalLinkTarget")),
                e.target = d[n];
                var i = t.rel;
                void 0 === i && (i = f("externalLinkRel")),
                e.rel = i
            }
        }
        ,
        ...
        t.isValidUrl = function(e, t) {
            (0,
            o.deprecated)("isValidUrl(), please use createValidAbsoluteUrl() instead.");
            var r = t ? "http://example.com" : null;
            return null !== (0,
            o.createValidAbsoluteUrl)(e, r)
        }
        ,
    ...
    , function(e, t, r) {
        ...
        : function(e) {
          ...
          , a = r(6)
          , v = r(14);
        var s, u, h = !1, b = !1, d = "undefined" != typeof document && document.currentScript ? document.currentScript.src : null, o = !1;
        "undefined" == typeof window ? (h = !0,
        void 0 === require.ensure && (require.ensure = require("node-ensure")),
        o = !0) : "undefined" != typeof require && "function" == typeof require.ensure && (o = !0),
        "undefined" != typeof requirejs && requirejs.toUrl && (s = requirejs.toUrl("pdfjs-dist/build/pdf.worker.js"));
        var _, c = "undefined" != typeof requirejs && requirejs.load;
        u = o ? function(t) {
        ...
        var f, y = function() {
            ...
            return e.prototype = {
                ...
                onDataRange: function(e, t) {
                    for (var r = this._rangeListeners, n = 0, i = r.length; n < i; ++n)
                        r[n](e, t)
                },
                onDataProgress: function(n) {
                    var i = this;
                    this._readyCapability.promise.then(function() {
                        for (var e = i._progressListeners, t = 0, r = e.length; t < r; ++t)
                            e[t](n)
                    })
                },
                onDataProgressiveRead: function(n) {
                    var i = this;
                    this._readyCapability.promise.then(function() {
                        for (var e = i._progressiveReadListeners, t = 0, r = e.length; t < r; ++t)
                            e[t](n)
                    })
                },
            ...
            function e(e, t, r) {
                ...
                g.getDefaultSetting)("enableStats"),
            ...
            return e.prototype = {
                ...
                getViewport: function(e, t) {
                    ...
                    new m.PageViewport(this.view,e,t,0,0)
                },
                ...
                render: function(e) {
                    ...
                    o.useRequestAnimationFrame = "print" !== t,
                    a.renderTasks || (a.renderTasks = []),
                    a.renderTasks.push(o);
                    var l = o.task;
                    return e.continueCallback && ((0,
                    m.deprecated)("render is used with continueCallback parameter"),
                    l.onContinue = e.continueCallback),
                    a.displayReadyCapability.promise.then(function(e) {
                        r.pendingCleanup ? s() : (n.time("Rendering"),
                        o.initializeGraphics(e),
                ...
                getOperatorList: function() {
                    ...
                    var t, r = this.intentStates[e];
                    return r.opListReadCapability || (t = {
                    ...
                    return new Promise(function(n, e) {
                        ...
                        !function r() {
                            t.read().then(function(e) {
                                var t = e.value;
                                e.done ? n(i) : (m.Util.extendObj(i.styles, t.styles),
                                m.Util.appendToArray(i.items, t.items),
                                r())
                            }, e)
                        }()
                    }
                ...
                destroy: function() {
                    (0,
                    m.deprecated)("page destroy method, use cleanup() instead"),
                    this.cleanup()
                },
                cleanup: function() {
                ...
                value: function(t, l) {
                    ...
                    if (this._defer) {
                        var c = new WeakMap
                          , r = {
                            data: function e(t) {
                                if ("object" !== (void 0 === t ? "undefined" : p(t)) || null === t)
                                    return t;
                                if (c.has(t))
                                    return c.get(t);
                                var r, n;
                                ...
                                m.isArrayBuffer)(n)) {
                                    ...
                                    return r = t === n ? t : i ? new t.constructor(n,t.byteOffset,t.byteLength) : new t.constructor(t),
                                    c.set(t, r),
                                    r
                                }
                                for (var a in r = (0,
                                ...
                                c.set(t, r),
                                t) {
                                    for (var s, o = t; !(s = Object.getOwnPropertyDescriptor(o, a)); )
            ...
            function c() {
                if (void 0 !== s)
                    return s;
                if ((0,
                g.getDefaultSetting)("workerSrc"))
                    return (0,
                    g.getDefaultSetting)("workerSrc");
                if (d)
                    return d.replace(/(\.(?:min\.)?js)(\?.*)?$/i, ".worker$1$2");
            ...
            return t.prototype = {
                ...
                _initializeFromPort: function(e) {
                    this._port = e,
                    this._messageHandler = new m.MessageHandler("main","worker",e),
                ...
                _initialize: function() {
                    var e, t, r = this;
                    if (!h && !(0,
                    g.getDefaultSetting)("disableWorker") && "undefined" != typeof Worker) {
                        var n = c();
                        try {
                            (0,
                            m.isSameOrigin)(window.location.href, n) || (e = new URL(n,window.location).href,
                            t = "importScripts('" + e + "');",
                            ...
                            a.on("test", function(e) {
                                (i.removeEventListener("error", o),
                                r.destroyed) ? s() : e && e.supportTypedArray ? (r._messageHandler = a,
                                r._port = i,
                                r._webWorker = i,
                            ...
                            var l = function() {
                                var e = (0,
                                g.getDefaultSetting)("postMessageTransfers") && !b
                                  , t = new Uint8Array([e ? 255 : 0]);
                                try {
                                    a.send("test", t, [t.buffer])
                                } catch (e) {
                                    (0,
                                    m.info)("Cannot use postMessage transfers"),
                                    t[0] = 0,
                                    a.send("test", t)
                                }
                            };
                            ...
                            (0,
                            m.info)("The worker has been disabled.")
                        }
                    }
                ...
                _setupFakeWorker: function() {
                    var s = this;
                    h || (0,
                    g.getDefaultSetting)("disableWorker") || ((0,
                    m.warn)("Setting up fake worker."),
                    h = !0),
                    (e || (e = (0,
                    m.createPromiseCapability)(),
                    (u || function(e) {
                    ...
                    e.promise).then(function(e) {
                        if (s.destroyed)
                            s._readyCapability.reject(new Error("Worker was destroyed"));
                        else {
            ...
            function e(e, t, r, n) {
                ...
                this.CMapReaderFactory = new n({
                    baseUrl: (0,
                    g.getDefaultSetting)("cMapUrl"),
                    isCompressed: (0,
                    g.getDefaultSetting)("cMapPacked")
                }),
                this.destroyed = !1,
            ...
            return e.prototype = {
                ...
                setupMessageHandler: function() {
                    ...
                    e.on("PasswordRequest", function(e) {
                        ...
                        r.onPassword) {
                            ...
                            this._passwordCapability.reject(new m.PasswordException(e.message,e.code));
                            ...
                            if (!this.commonObjs.hasData(r))
                                ...
                                case "Font":
                                    ...
                                    if ("error"in i) {
                                        var a = i.error;
                                        (0,
                                        m.warn)("Error during font loading: " + a),
                                        this.commonObjs.resolve(r, a);
                                        break
                                    }
                                    var s = null;
                                    (0,
                                    g.getDefaultSetting)("pdfBug") && m.globalScope.FontInspector && m.globalScope.FontInspector.enabled && (s = {
                                        registerFont: function(e, t) {
                                            m.globalScope.FontInspector.fontAdded(e, t)
                                        }
                                    });
                                    var o = new l.FontFaceObject(i,{
                                        isEvalSuported: (0,
                                        g.getDefaultSetting)("isEvalSupported"),
                                        disableFontFace: (0,
                                        g.getDefaultSetting)("disableFontFace"),
                                        fontRegistry: s
                                    });
                    ...
                    e.on("UnsupportedFeature", function(e) {
                        if (!this.destroyed) {
                            var t = e.featureId
                              , r = this.loadingTask;
                            r.onUnsupportedFeature && r.onUnsupportedFeature(t),
                            E.notify(t)
                        }
                    }, this),
                    e.on("JpegDecode", function(e) {
                        ...
                        var t = e[0]
                          , d = e[1];
                        return 3 !== d && 1 !== d ? Promise.reject(new Error("Only 3 components or 1 component can be returned")) : new Promise(function(u, e) {
                            var h = new Image;
                            h.onload = function() {
                                var e = h.width
                                  , t = h.height
                                ...
                                s.drawImage(h, 0, 0);
                                var o, l, c = s.getImageData(0, 0, e, t).data;
                                if (3 === d)
                                    for (l = o = 0; o < n; o += 4,
                                    l += 3)
                                        i[l] = c[o],
                ...
                getMetadata: function() {
                    return this.messageHandler.sendWithPromise("GetMetadata", null).then(function(e) {
                        return {
                            info: e[0],
                            metadata: e[1] ? new a.Metadata(e[1]) : null
                        }
                    })
                },
                getStats: function() {
            ...
            return e.prototype = {
                initializeGraphics: function(e) {
                    if (this._canvas) {
                        if (r.has(this._canvas))
                            throw new Error("Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed.");
                        r.set(this._canvas, this)
                    }
                    if (!this.cancelled) {
                        (0,
                        g.getDefaultSetting)("pdfBug") && m.globalScope.StepperManager && m.globalScope.StepperManager.enabled && (this.stepper = m.globalScope.StepperManager.create(this.pageNumber - 1),
                ...
                cancel: function() {
                    ...
                    (0,
                    g.getDefaultSetting)("pdfjsNext") ? this.callback(new g.RenderingCancelledException("Rendering cancelled, page " + this.pageNumber,"canvas")) : this.callback("cancelled")
                },
                operatorListChanged: function() {
        ...
        }(), E = (f = [],
        {
            listen: function(e) {
                (0,
                m.deprecated)("Global UnsupportedManager.listen is used:  use PDFDocumentLoadingTask.onUnsupportedFeature instead"),
                f.push(e)
            },
            notify: function(e) {
        ...
        t.getDocument = function(e, t, r, n) {
            ...
            m.deprecated)("getDocument is called with pdfDataRangeTransport, passwordCallback or progressCallback argument"),
            t && (t instanceof A || ((t = Object.create(t)).length = e.length,
            t.initialData = e.initialData,
            t.abort || (t.abort = function() {}
            )),
            (e = Object.create(e)).range = t),
            a.onPassword = r || null,
            a.onProgress = n || null,
            "string" == typeof e)
                i = {
            ...
            for (var u in i)
                if ("url" !== u || "undefined" == typeof window)
                    if ("range" !== u)
                        if ("worker" !== u)
                            if ("data" !== u || i[u]instanceof Uint8Array)
                                "CMapReaderFactory" !== u ? s[u] = i[u] : c = i[u];
                            else {
                                var h = i[u];
                                if ("string" == typeof h)
                                    s[u] = (0,
                    ...
                    s[u] = new URL(i[u],window.location).href;
            if (s.rangeChunkSize = s.rangeChunkSize || 65536,
            s.ignoreErrors = !0 !== s.stopAtErrors,
            void 0 !== s.disableNativeImageDecoder && (0,
            m.deprecated)("parameter disableNativeImageDecoder, use nativeImageDecoderSupport instead"),
            ...
            s.nativeImageDecoderSupport !== m.NativeImageDecoding.DECODE && s.nativeImageDecoderSupport !== m.NativeImageDecoding.NONE && s.nativeImageDecoderSupport !== m.NativeImageDecoding.DISPLAY && ((0,
            m.warn)("Invalid parameter nativeImageDecoderSupport: need a state of enum {NativeImageDecoding}"),
            s.nativeImageDecoderSupport = m.NativeImageDecoding.DECODE),
            !l) {
                var d = (0,
                g.getDefaultSetting)("workerPort");
                l = d ? C.fromPort(d) : new C,
                a._worker = l
            }
            var f = a.docId;
            return l.promise.then(function() {
                ...
                r = o,
                n = f,
                t.destroyed ? Promise.reject(new Error("Worker was destroyed")) : (e.disableAutoFetch = (0,
                g.getDefaultSetting)("disableAutoFetch"),
                e.disableStream = (0,
                g.getDefaultSetting)("disableStream"),
                ...
                t.messageHandler.sendWithPromise("GetDocRequest", {
                    ...
                    maxImageSize: (0,
                    g.getDefaultSetting)("maxImageSize"),
                    disableFontFace: (0,
                    g.getDefaultSetting)("disableFontFace"),
                    disableCreateObjectURL: (0,
                    g.getDefaultSetting)("disableCreateObjectURL"),
                    ...
                    if (a.destroyed)
                        throw new Error("Loading aborted");
                    var t = void 0;
                    o ? t = new v.PDFDataTransportStream(s,o) : s.data || (t = new _({
                        source: s,
                        disableRange: (0,
                        g.getDefaultSetting)("disableRange")
                    }));
                ...
                case d.AnnotationType.WIDGET:
                    ...
                    case "Btn":
                        ...
                        if (e.data.checkBox)
                            return new c(e);
                        (0,
                        d.warn)("Unimplemented button widget annotation: pushbutton");
                        break;
                    case "Ch":
                        return new f(e)
                    }
        ...
        var n = function() {
            ...
            return e.prototype = {
                _createContainer: function(e) {
                    ...
                    if (h.CustomStyle.setProp("transform", i, "matrix(" + n.transform.join(",") + ")"),
                    h.CustomStyle.setProp("transformOrigin", i, -o[0] + "px " + -o[1] + "px"),
                    !e && 0 < t.borderStyle.width) {
                        i.style.borderWidth = t.borderStyle.width + "px",
                        t.borderStyle.style !== d.AnnotationBorderStyleType.UNDERLINE && (a -= 2 * t.borderStyle.width,
                        ...
                        case d.AnnotationBorderStyleType.BEVELED:
                            (0,
                            d.warn)("Unimplemented border style: beveled");
                            break;
                        case d.AnnotationBorderStyleType.INSET:
                            (0,
                            d.warn)("Unimplemented border style: inset");
                            break;
          ...
          , i = function() {
            ...
            return d.Util.inherit(e, n, {
                render: function() {
                    this.container.className = "linkAnnotation";
                    var e = document.createElement("a");
                    return (0,
                    h.addLinkAttributes)(e, {
                        url: this.data.url,
                        target: this.data.newWindow ? h.LinkTarget.BLANK : void 0
                    }),
          ...
          , l = function() {
            ...
            return d.Util.inherit(e, o, {
                render: function() {
                    ...
                    return null !== this.data.textAlignment && (e.style.textAlign = n[this.data.textAlignment]),
                    this.container.appendChild(e),
                    this.container
                },
            ...
            return d.Util.inherit(e, o, {
                render: function() {
                    ...
                    for (var t = 0, r = this.data.options.length; t < r; t++) {
                        ...
                        0 <= this.data.fieldValue.indexOf(n.displayValue) && i.setAttribute("selected", !0),
                        e.appendChild(i)
                    }
          ...
          , p = function() {
            ...
            return d.Util.inherit(e, n, {
                render: function() {
                    ...
                    0 <= a.indexOf(this.data.parentType))
                        return this.container;
                    ...
                    return h.CustomStyle.setProp("transformOrigin", this.container, -(n + i) + "px -" + t.style.top),
          ...
          , m = function() {
            ...
            return e.prototype = {
                render: function() {
                    ...
                    return o.textContent = this.title,
          ...
          , g = function() {
            ...
            return d.Util.inherit(e, n, {
                render: function() {
                    ...
                    return i.setAttributeNS(null, "x1", e.rect[2] - e.lineCoordinates[0]),
          ...
          , A = function() {
            function e(e) {
                ...
                this.filename = (0,
                h.getFilenameFromUrl)(t.filename),
                this.content = t.content,
                this.linkService.onFileAttachmentAnnotation({
                    id: (0,
                    d.stringToPDFString)(t.filename),
                    filename: t.filename,
                    content: t.content
                })
            }
            return d.Util.inherit(e, n, {
                ...
                _download: function() {
                    ...
                    d.warn)("Download cannot be started due to unavailable download manager")
                }
            }),
            e
        }()
                ...
                for (var t = new s, r = 0, n = e.annotations.length; r < n; r++) {
                    ...
                    if (i) {
                        var a = t.create({
                            ...
                            imageResourcesPath: e.imageResourcesPath || (0,
                            h.getDefaultSetting)("imageResourcesPath"),
    ...
    , function(e, t, r) {
        ...
        var n, S = r(0), b = "normal", _ = "normal", y = "#000000", c = function() {
            for (var _ = new Uint8Array([137, 80, 78, 71, 13, 10, 26, 10]), o = new Int32Array(256), e = 0; e < 256; e++) {
                for (var t = e, r = 0; r < 8; r++)
                    t = 1 & t ? 3988292384 ^ t >> 1 & 2147483647 : t >> 1 & 2147483647;
                o[e] = t
            }
            function y(e, t, r, n) {
                var i = n
            ...
            function n(e, t, r) {
                var n, i, a, s = e.width, o = e.height, l = e.data;
                switch (t) {
                ...
                var c, u, h = new Uint8Array((1 + a) * o), d = 0, f = 0;
                for (c = 0; c < o; ++c)
                    h[d++] = 0,
                    h.set(l.subarray(f, f + a), d),
                    f += a,
                    d += a;
                if (t === S.ImageKind.GRAYSCALE_1BPP)
                    for (c = d = 0; c < o; c++)
                        for (d++,
                        u = 0; u < a; u++)
                            h[d++] ^= 255;
                var p = new Uint8Array([s >> 24 & 255, s >> 16 & 255, s >> 8 & 255, 255 & s, o >> 24 & 255, o >> 16 & 255, o >> 8 & 255, 255 & o, n, i, 0, 0, 0])
                  ...
                  , b = 0;
                return v.set(_, b),
                y("IHDR", p, v, b += _.length),
                y("IDATA", m, v, b += 12 + p.length),
                b += 12 + m.length,
                y("IEND", new Uint8Array(0), v, b),
                (0,
                S.createObjectURL)(v, "image/png", r)
            }
            return function(e, t) {
        ...
        t.SVGGraphics = n = function() {
            ...
            function v(e) {
                if (0 === e[4] && 0 === e[5]) {
                    if (0 === e[1] && 0 === e[2])
                        return 1 === e[0] && 1 === e[3] ? "" : "scale(" + g(e[0]) + " " + g(e[3]) + ")";
                    if (e[0] === e[3] && e[1] === -e[2])
                        return "rotate(" + g(180 * Math.acos(e[0]) / Math.PI) + ")"
                } else if (1 === e[0] && 0 === e[1] && 0 === e[2] && 1 === e[3])
                    return "translate(" + g(e[4]) + " " + g(e[5]) + ")";
            ...
            return e.prototype = {
                    ...
                    for (var t = this, r = e.fnArray, n = r.length, i = e.argsArray, a = 0; a < n; a++)
                        if (S.OPS.dependency === r[a])
                            for (var s = i[a], o = 0, l = s.length; o < l; o++) {
                                var c, u = s[o];
                                c = "g_" === u.substring(0, 2) ? new Promise(function(e) {
                ...
                transform: function(e, t, r, n, i, a) {
                    var s = [e, t, r, n, i, a];
                    this.transformMatrix = S.Util.transform(this.transformMatrix, s),
                    this.tgrp = null
                },
                getSVG: function(t, e) {
                    var r = this;
                ...
                executeOpTree: function(e) {
                    for (var t = e.length, r = 0; r < t; r++) {
                        ...
                        default:
                            (0,
                            S.warn)("Unimplemented operator " + n)
                        }
                    }
                },
                ...
                showText: function(e) {
                    var t = this.current
                      ...
                      , n = t.fontSize;
                    if (0 !== n) {
                        var i, a = t.charSpacing, s = t.wordSpacing, o = t.fontDirection, l = t.textHScale * o, c = e.length, u = r.vertical, h = n * t.fontMatrix[0], d = 0;
                        for (i = 0; i < c; ++i) {
                            var f = e[i];
                            if (null !== f)
                                if ((0,
                                S.isNum)(f))
                                    ...
                                    var p = f.width
                                      , m = f.fontChar;
                                    d += p * h + ((f.isSpace ? s : 0) + a) * o,
                                    t.tspan.textContent += m
                                }
                            else
                                d += o * s
                        }
                ...
                addFontStyle: function(e) {
                    this.cssStyle || (this.cssStyle = document.createElementNS(h, "svg:style"),
                ...
                constructPath: function(e, t) {
                    ...
                    for (var a = [], s = e.length, o = 0, l = 0; o < s; o++)
                        ...
                        case S.OPS.curveTo:
                            n = t[l + 4],
                            i = t[l + 5],
                            a.push("C", g(t[l]), g(t[l + 1]), g(t[l + 2]), g(t[l + 3]), g(n), g(i)),
                            l += 6;
                            break;
                        case S.OPS.curveTo2:
                            n = t[l + 2],
                            i = t[l + 3],
                            a.push("C", g(n), g(i), g(t[l]), g(t[l + 1]), g(t[l + 2]), g(t[l + 3])),
                            l += 4;
                            break;
                        case S.OPS.curveTo3:
                            n = t[l + 2],
                            i = t[l + 3],
                            a.push("C", g(t[l]), g(t[l + 1]), g(n), g(i), g(n), g(i)),
                            l += 4;
                            break;
                        case S.OPS.closePath:
                            a.push("Z")
                        }
                    r.path.setAttributeNS(null, "d", a.join(" ")),
                ...
                endPath: function() {
                    if (this.pendingClip) {
                        ...
                        r.setAttributeNS(null, "transform", v(this.transformMatrix));
                ...
                setGState: function(e) {
                    for (var t = 0, r = e.length; t < r; t++) {
                        ...
                        default:
                            (0,
                            S.warn)("Unimplemented graphic state " + i)
                        }
                    }
                },
                fill: function() {
                ...
                paintInlineImageXObject: function(e, t) {
                    ...
                    a.setAttributeNS(null, "width", g(r)),
                    a.setAttributeNS(null, "height", g(n)),
                ...
                paintFormXObjectBegin: function(e, t) {
                    if ((0,
                    S.isArray)(e) && 6 === e.length && this.transform(e[0], e[1], e[2], e[3], e[4], e[5]),
                    (0,
                    S.isArray)(t) && 4 === t.length) {
                        var r = t[2] - t[0]
                          , n = t[3] - t[1]
                ...
                _initialize: function(e) {
                    ...
                    return n.setAttributeNS(null, "transform", v(e.transform)),
                    t.appendChild(n),
                    this.svg = n,
                    t
                },
                ...
                _ensureTransformGroup: function() {
                    return this.tgrp || (this.tgrp = document.createElementNS(h, "svg:g"),
    ...
    , function(e, t, r) {
        ...
        var A = r(0)
          ...
          , n = function() {
            ...
            function i(e, t, r) {
                var n, i = document.createElement("div"), a = {
                    style: null,
                    angle: 0,
                    canvasWidth: 0,
                    isWhitespace: !1,
                ...
                n = t.str,
                !_.test(n))
                    return a.isWhitespace = !0,
                    void e._textDivProperties.set(i, a);
                var s = A.Util.transform(e._viewport.transform, t.transform)
                  , o = Math.atan2(s[1], s[0])
                  , l = r[t.fontName];
                l.vertical && (o += Math.PI / 2);
                var c, u, h = Math.sqrt(s[2] * s[2] + s[3] * s[3]), d = h;
                if (l.ascent ? d = l.ascent * d : l.descent && (d = (1 + l.descent) * d),
                0 === o ? (c = s[4],
                u = s[5] - d) : (c = s[4] + d * Math.sin(o),
                u = s[5] - d * Math.cos(o)),
                y[1] = c,
                y[3] = u,
                y[5] = h,
                ...
                i.textContent = t.str,
                (0,
                S.getDefaultSetting)("pdfBug") && (i.dataset.fontName = t.fontName),
                ...
                e._enhanceTextSelection) {
                    ...
                    0 !== o && (f = Math.cos(o),
                    p = Math.sin(o));
                    var m, g, v = (l.vertical ? t.height : t.width) * e._viewport.scale, b = h;
                    0 !== o ? (m = [f, p, -p, f, c, u],
                    g = A.Util.getAxialAlignedBoundingBox([0, 0, v, b], m)) : g = [c, u, c + v, u + b],
                    e._bounds.push({
                        left: g[0],
                        top: g[1],
                        right: g[2],
            ...
            function l(e) {
                for (var t = e._bounds, r = e._viewport, n = function(i, e, t) {
                    ...
                    s
                }(r.width, r.height, t), i = 0; i < n.length; i++) {
                    var a = t[i].div
                    ...
                    if (0 !== s.angle) {
                        ...
                        s.paddingLeft = p(f, 32, 16) / m,
                        s.paddingTop = p(f, 48, 16) / m,
                        s.paddingRight = p(f, 0, 16) / m,
                        s.paddingBottom = p(f, 16, 16) / m,
                        e._textDivProperties.set(a, s)
                    } else
                        s.paddingLeft = t[i].left - n[i].left,
                        s.paddingTop = t[i].top - n[i].top,
                        s.paddingRight = n[i].right - t[i].right,
                        s.paddingBottom = n[i].bottom - t[i].bottom,
                        e._textDivProperties.set(a, s)
                }
            }
            function g(r, e) {
                ...
                e.forEach(function(e) {
                    for (var t = 0; t < f.length && f[t].end <= e.y1; )
                        t++;
                    for (var r, n, i = f.length - 1; 0 <= i && f[i].start >= e.y2; )
                        i--;
                    var a, s, o = -1 / 0;
                    for (a = t; a <= i; a++) {
                        var l;
                    ...
                    for (e.x1New = o,
                    a = t; a <= i; a++)
                        void 0 === (n = (r = f[a]).boundary).x2New ? n.x2 > e.x1 ? n.index > e.index && (n.x2New = n.x2) : n.x2New = o : n.x2New > o && (n.x2New = Math.max(o, n.x2));
                    var c = []
                      , u = null;
                    for (a = t; a <= i; a++) {
                        var h = (n = (r = f[a]).boundary).x2 > e.x2 ? n : e;
                        u === h ? c[c.length - 1].end = r.end : (c.push({
                            start: r.start,
                            end: r.end,
                            boundary: h
                        }),
                    ...
                    for (f[t].start < e.y1 && (c[0].start = e.y1,
                    c.unshift({
                        start: f[t].start,
                        end: e.y1,
                        boundary: f[t].boundary
                    })),
                    e.y2 < f[i].end && (c[c.length - 1].end = e.y2,
                    c.push({
                        start: e.y2,
                        end: f[i].end,
                    ...
                    a = t; a <= i; a++)
                        if (void 0 === (n = (r = f[a]).boundary).x2New) {
                            var d = !1;
                            for (s = t - 1; !d && 0 <= s && f[s].start >= n.y1; s--)
                                d = f[s].boundary === n;
                            for (s = i + 1; !d && s < f.length && f[s].end <= n.y2; s++)
                                d = f[s].boundary === n;
            ...
            return r.prototype = {
                ...
                cancel: function() {
                    this._reader && (this._reader.cancel(new A.AbortException("text layer task cancelled")),
                    this._reader = null),
                    this._canceled = !0,
                ...
                _layoutText: function(e) {
                    ...
                    if (!r.isWhitespace) {
                        ...
                        var a = this._layoutTextCtx.measureText(e.textContent).width
                          , s = "";
                        0 !== r.canvasWidth && 0 < a && (r.scale = r.canvasWidth / a,
                        s = "scaleX(" + r.scale + ")"),
                        0 !== r.angle && (s = "rotate(" + r.angle + "deg) " + s),
                        "" !== s && (r.originalTransform = s,
                        S.CustomStyle.setProp("transform", e, s)),
                ...
                _render: function(e) {
                    ...
                    if (t.mozOpaque = !0,
                    this._layoutTextCtx = t.getContext("2d", {
                        alpha: !1
                    }),
                    this._textContent) {
                        var r = this._textContent.items
                          , s = this._textContent.styles;
                        this._processItems(r, s),
                        i.resolve()
                    } else {
                        ...
                        function r() {
                            n._reader.read().then(function(e) {
                                var t = e.value;
                                e.done ? i.resolve() : (A.Util.extendObj(a, t.styles),
                                n._processItems(t.items, a),
                                r())
                            }, i.reject)
                        }()
                    }
                    i.promise.then(function() {
                        a = null,
                        e ? n._renderTimer = setTimeout(function() {
                            o(n),
                            n._renderTimer = null
                        }, e) : o(n)
                        ...
                        for (var t = 0, r = this._textDivs.length; t < r; t++) {
                            ...
                            if (!i.isWhitespace)
                                if (e) {
                                    ...
                                    0 !== i.paddingLeft && (s += " padding-left: " + i.paddingLeft / i.scale + "px;",
                                    a += " translateX(" + -i.paddingLeft / i.scale + "px)"),
                                    0 !== i.paddingTop && (s += " padding-top: " + i.paddingTop + "px;",
                                    ...
                                    n.style.padding = 0,
                                    S.CustomStyle.setProp("transform", n, i.originalTransform || "")
                        }
                    }
                }
            },
        ...
        n.prototype = {
            parse: function() {
                ...
                if (e && "rdf:rdf" === t && e.hasChildNodes()) {
                    var r, n, i, a, s, o, l, c = e.childNodes;
                    for (a = 0,
                    o = c.length; a < o; a++)
                        if ("rdf:description" === (r = c[a]).nodeName.toLowerCase())
                            for (s = 0,
                            l = r.childNodes.length; s < l; s++)
                                "#text" !== r.childNodes[s].nodeName.toLowerCase() && (i = (n = r.childNodes[s]).nodeName.toLowerCase(),
                                this.metadata[i] = n.textContent.trim())
                }
            },
            get: function(e) {
    ...
    , function(e, t, r) {
        ...
        var n = r(1)
          ...
          , a = function() {
            ...
            var L, D;
            function O() {
                L || (D = document.createElement("canvas"),
                L = D.getContext("webgl", {
                    premultipliedalpha: !1
                }))
            }
            var d = "  attribute vec2 a_position;                                      attribute vec2 a_texCoord;                                                                                                      uniform vec2 u_resolution;                                                                                                      varying vec2 v_texCoord;                                                                                                        void main() {                                                     vec2 clipSpace = (a_position / u_resolution) * 2.0 - 1.0;       gl_Position = vec4(clipSpace * vec2(1, -1), 0, 1);                                                                              v_texCoord = a_texCoord;                                      }                                                             "
              , f = "  precision mediump float;                                                                                                        uniform vec4 u_backdrop;                                        uniform int u_subtype;                                          uniform sampler2D u_image;                                      uniform sampler2D u_mask;                                                                                                       varying vec2 v_texCoord;                                                                                                        void main() {                                                     vec4 imageColor = texture2D(u_image, v_texCoord);               vec4 maskColor = texture2D(u_mask, v_texCoord);                 if (u_backdrop.a > 0.0) {                                         maskColor.rgb = maskColor.rgb * maskColor.a +                                   u_backdrop.rgb * (1.0 - maskColor.a);         }                                                               float lum;                                                      if (u_subtype == 0) {                                             lum = maskColor.a;                                            } else {                                                          lum = maskColor.r * 0.3 + maskColor.g * 0.59 +                        maskColor.b * 0.11;                                     }                                                               imageColor.a *= lum;                                            imageColor.rgb *= imageColor.a;                                 gl_FragColor = imageColor;                                    }                                                             "
              , p = null;
            var F = "  attribute vec2 a_position;                                      attribute vec3 a_color;                                                                                                         uniform vec2 u_resolution;                                      uniform vec2 u_scale;                                           uniform vec2 u_offset;                                                                                                          varying vec4 v_color;                                                                                                           void main() {                                                     vec2 position = (a_position + u_offset) * u_scale;              vec2 clipSpace = (position / u_resolution) * 2.0 - 1.0;         gl_Position = vec4(clipSpace * vec2(1, -1), 0, 1);                                                                              v_color = vec4(a_color / 255.0, 1.0);                         }                                                             "
              , N = "  precision mediump float;                                                                                                        varying vec4 v_color;                                                                                                           void main() {                                                     gl_FragColor = v_color;                                       }                                                             "
              , M = null;
            return {
                get isEnabled() {
                    if ((0,
                ...
                composeSMask: function(e, t, r) {
                    ...
                    var l = h(o, e, o.TEXTURE0)
                      , c = h(o, t, o.TEXTURE1)
                      , u = o.createBuffer();
                    return o.bindBuffer(o.ARRAY_BUFFER, u),
                ...
                drawFigures: function(e, t, r, n, i) {
                    ...
                    r ? o.clearColor(r[0] / 255, r[1] / 255, r[2] / 255, 1) : o.clearColor(0, 0, 0, 0),
                    o.clear(o.COLOR_BUFFER_BIT);
                    ...
                    return o.bindBuffer(o.ARRAY_BUFFER, x),
    ...
    , function(e, t, r) {
        ...
        Object.defineProperty(h, "openExternalLinksInNewWindow", {
            ...
            set: function(e) {
                ...
                h.externalLinkTarget === i.LinkTarget.NONE ? h.externalLinkTarget = e ? i.LinkTarget.BLANK : i.LinkTarget.NONE : (0,
    ...
    , function(e, t, r) {
        ...
        var o = function() {
            try {
                ...
                return e.open("GET", i.globalScope.location.href),
        ...
        a.prototype = {
            ...
            request: function(t) {
                ...
                return o && !!t.onProgressiveData ? (r.responseType = "moz-chunked-arraybuffer",
                n.onProgressiveData = t.onProgressiveData,
                n.mozChunked = !0) : r.responseType = "arraybuffer",
                t.onError && (r.onerror = function(e) {
                    t.onError(r.status)
                }
                ),
            ...
            onStateChange: function(e, t) {
                ...
                if (r) {
                    var n = r.xhr;
                    if (2 <= n.readyState && r.onHeadersReceived && (r.onHeadersReceived(),
        ...
        l.prototype = {
            _validateRangeRequestCapabilities: function() {
                ...
                var t = this._fullRequestId
                  , r = e.getRequestXhr(t);
                if ("bytes" !== r.getResponseHeader("Accept-Ranges"))
                    return !1;
                if ("identity" !== (r.getResponseHeader("Content-Encoding") || "identity"))
                    return !1;
                var n = r.getResponseHeader("Content-Length");
                return n = parseInt(n, 10),
                !!(0,
                i.isInt)(n) && !((this._contentLength = n) <= 2 * this._rangeChunkSize)
            },
            _onHeadersReceived: function() {
                this._validateRangeRequestCapabilities() && (this._isRangeSupported = !0);
                var e = this._manager
                  , t = this._fullRequestId;
                e.isStreamingRequest(t) ? this._isStreamingSupported = !0 : this._isRangeSupported && e.abortRequest(t),
                this._headersReceivedCapability.resolve()
            },
            _onProgressiveData: function(e) {
                0 < this._requests.length ? this._requests.shift().resolve({
                    value: e,
                    done: !1
            ...
            _onDone: function(e) {
                ...
                this._done = !0,
                0 < this._cachedChunks.length || (this._requests.forEach(function(e) {
                    e.resolve({
                        value: void 0,
                        done: !0
                    })
            ...
            _onError: function(e) {
                var t, r = this._url;
                t = 404 === e || 0 === e && /^file:/.test(r) ? new i.MissingPDFException('Missing PDF "' + r + '".') : new i.UnexpectedResponseException("Unexpected server response (" + e + ') while retrieving PDF "' + r + '".',e),
                this._storedError = t,
    ...
    , function(e, t, r) {
        ...
        !function(e, t) {
            ...
            n.ValidateAndNormalizeQueuingStrategy = function(e, t) {
                ...
                return {
                    size: e,
                    highWaterMark: t = n.ValidateAndNormalizeHighWaterMark(t)
                }
            }
        }
        , function(e, t, r) {
        ...
        , function(e, t, r) {
            ...
            var i = r(0)
              ...
              , b = function() {
                function a() {
                    ...
                    this._writableStreamController = new j(this,e,r,i),
            ...
            function A(e) {
                return d(!0 === y(e), "IsWritableStreamLocked should only be used on known writable streams"),
                void 0 !== e._writer
            }
            function S(r, n) {
                var e = r._state;
                ...
                if (void 0 !== r._pendingAbortRequest)
            ...
            function w(e, t) {
                var r = e._state;
                "writable" !== r ? (d("erroring" === r),
                C(e)) : P(e, t)
            }
            function P(e, t) {
                d(void 0 === e._storedError, "stream._storedError === undefined"),
                d("writable" === e._state, "state must be writable");
                var r = e._writableStreamController;
                d(void 0 !== r, "controller must not be undefined"),
                e._state = "erroring",
                e._storedError = t;
                var n = e._writer;
                void 0 !== n && F(n, t),
            ...
            function C(t) {
                d("erroring" === t._state, "stream._state === erroring"),
                d(!1 === x(t), "WritableStreamHasOperationMarkedInFlight(stream) === false"),
                t._state = "errored",
                t._writableStreamController.__errorSteps();
                ...
                void 0 !== t._pendingAbortRequest) {
                    ...
                    if (!(t._pendingAbortRequest = void 0) === n._wasAlreadyErroring)
                        return n._reject(e),
                        void T(t);
                    t._writableStreamController.__abortSteps(n._reason).then(function() {
                        n._resolve(),
                        T(t)
                    }, function(e) {
                        n._reject(e),
            ...
            function R(e) {
                d(void 0 !== e._inFlightCloseRequest),
                e._inFlightCloseRequest._resolve(void 0),
                e._inFlightCloseRequest = void 0;
                var t = e._state;
                d("writable" === t || "erroring" === t),
                "erroring" === t && (e._storedError = void 0) !== e._pendingAbortRequest && (e._pendingAbortRequest._resolve(),
                e._pendingAbortRequest = void 0),
                e._state = "closed";
                var r, n = e._writer;
                void 0 !== n && (d(void 0 !== (r = n)._closedPromise_resolve, "writer._closedPromise_resolve !== undefined"),
            ...
            function T(e) {
                d("errored" === e._state, '_stream_.[[state]] is `"errored"`'),
                void 0 !== e._closeRequest && (d(void 0 === e._inFlightCloseRequest),
            ...
            function E(e, t) {
                ...
                d(!1 === k(e));
                var r, n = e._writer;
                void 0 !== n && t !== e._backpressure && (!0 === t ? (d(void 0 === (r = n)._readyPromise_resolve, "writer._readyPromise_resolve === undefined"),
                ...
                r._readyPromiseState = "pending") : (d(!1 === t),
                K(n))),
                e._backpressure = t
            }
            e.exports = {
                ...
                WritableStreamDefaultWriterCloseWithErrorPropagation: function(e) {
                    ...
                    return d("writable" === r || "erroring" === r),
                    D(e)
                },
            ...
            var I = function() {
                function o(e) {
                    ...
                    var t, r, n, i, a = e._state;
                    if ("writable" === a)
                        !1 === k(e) && !0 === e._backpressure ? ((i = this)._readyPromise = new Promise(function(e, t) {
                            i._readyPromise_resolve = e,
                            i._readyPromise_reject = t
                        }
                        ),
                        i._readyPromiseState = "pending") : Q(this),
                        Y(this);
                    else if ("erroring" === a)
                        J(this, e._storedError),
                        this._readyPromise.catch(function() {}),
                        Y(this);
                    else if ("closed" === a)
                        Q(this),
                        (n = this)._closedPromise = Promise.resolve(void 0),
                ...
                return n(o, [{
                    key: "abort",
                    value: function(e) {
                        return !1 === L(this) ? Promise.reject(H("abort")) : void 0 === this._ownerWritableStream ? Promise.reject(X("abort")) : (t = e,
                        r = this._ownerWritableStream,
                        d(void 0 !== r),
                        S(r, t));
                        var t, r
                    }
            ...
            function D(e) {
                ...
                d("writable" === t || "erroring" === t),
                d(!1 === k(n));
                var r, i = new Promise(function(e, t) {
                    var r = {
                        _resolve: e,
                        _reject: t
                    };
                ...
                return !0 === n._backpressure && "writable" === t && K(e),
            ...
            function O(e, t) {
                var r, n;
                "pending" === e._closedPromiseState ? V(e, t) : (n = t,
            ...
            function F(e, t) {
                var r, n, i, a;
                "pending" === e._readyPromiseState ? (a = t,
                ...
                i._readyPromiseState = "rejected") : (n = t,
            ...
            var j = function() {
                function a(e, t, r, n) {
                    ...
                    this._started = !1;
                    var i = o(r, n);
                    this._strategySize = i.size,
                    this._strategyHWM = i.highWaterMark,
                    E(e, B(this))
                }
                return n(a, [{
                    key: "error",
                    ...
                    value: function() {
                        ...
                        Promise.resolve(e).then(function() {
                            d("writable" === r._state || "erroring" === r._state),
                            t._started = !0,
                            U(t)
                        }, function(e) {
                            d("writable" === r._state || "erroring" === r._state),
                    ...
                    if ("closed" !== r && "errored" !== r)
                        if ("erroring" !== r) {
                            if (0 !== e._queue.length) {
                                var n, i, a, s, o, l, c, u = g(e);
                                "close" === u ? (l = (o = e)._controlledWritableStream,
                                ...
                                h(o._underlyingSink, "close", []).then(function() {
                                    R(l)
                                }, function(e) {
                                    var t, r;
                                    r = e,
                                ...
                                h(n._underlyingSink, "write", [i, n]).then(function() {
                                    var e;
                                    d(void 0 !== (e = a)._inFlightWriteRequest),
                                    e._inFlightWriteRequest._resolve(void 0),
                                    e._inFlightWriteRequest = void 0;
                                    var t = a._state;
                                    if (d("writable" === t || "erroring" === t),
                                    p(n),
                                    !1 === k(a) && "writable" === t) {
                                        var r = B(n);
                                        E(a, r)
            ...
            function Y(r) {
                r._closedPromise = new Promise(function(e, t) {
                    r._closedPromise_resolve = e,
                    r._closedPromise_reject = t,
                    r._closedPromiseState = "pending"
                }
                )
            }
            function V(e, t) {
        ...
        , function(e, t, r) {
            ...
            var i = r(0)
              ...
              , O = function() {
                function a() {
                    ...
                    if ("bytes" === String(i))
                        void 0 === n && (n = 0),
                        this._readableStreamController = new he(this,e,n);
                    else {
                        if (void 0 !== i)
                            throw new RangeError("Invalid type is specified");
                        void 0 === n && (n = 1),
                        this._readableStreamController = new re(this,e,r,n)
                    }
                }
                return n(a, [{
                    key: "cancel",
                    ...
                    value: function(h) {
                        var d = this
                          ...
                          , m = e.preventCancel;
                        if (!1 === N(this))
                            return Promise.reject(xe("pipeTo"));
                        if (!1 === k(h))
                        ...
                        return new Promise(function(r, n) {
                            var e, t, i;
                            if (o(d, g._closedPromise, function(e) {
                                !1 === p ? l(function() {
                                    return T(h, e)
                                }, !0, e) : c(!0, e)
                            }),
                            ...
                            function l(e, t, r) {
                                ...
                                !0 !== b && (b = !0,
                                "writable" === h._state && !1 === D(h) ? s().then(n) : n())
                            }
                            function c(e, t) {
                                !0 !== b && (b = !0,
                                "writable" === h._state && !1 === D(h) ? s().then(function() {
                                    return u(e, t)
                                }).catch(y) : u(e, t))
                            }
                            function u(e, t) {
                            ...
                            (function e() {
                                ...
                                !0 === b ? Promise.resolve() : v._readyPromise.then(function() {
                        ...
                        var e = function(e, t) {
                            ...
                            var i = function e() {
                                ...
                                return te(t).then(function(e) {
                                    ...
                                    var t = e.value
                                      , r = e.done;
                                    if (_("boolean" == typeof r),
                                    !0 === r && !1 === o.closedOrErrored && (!1 === o.canceled1 && ae(a),
                                    !1 === o.canceled2 && ae(s),
                                    o.closedOrErrored = !0),
                                    !0 !== o.closedOrErrored) {
                                        var n = t
                                          , i = t;
                                        !1 === o.canceled1 && se(a, n),
                                        !1 === o.canceled2 && se(s, i)
                                    }
                                })
                            };
                            i._reader = r,
                            ...
                            g(c, "cancel", s);
                            var u = new O(c);
                            return i._branch1 = l._readableStreamController,
                            i._branch2 = u._readableStreamController,
                            r._closedPromise.catch(function(e) {
                                !0 !== n.closedOrErrored && (oe(i._branch1, e),
                                oe(i._branch2, e),
                                n.closedOrErrored = !0)
                            }),
                            [l, u]
            ...
            function M(e) {
                return _(!0 === N(e), "IsReadableStreamLocked should only be used on known readable streams"),
                void 0 !== e._reader
            }
            function j(n) {
                return _(!0 === Q(n._reader)),
            ...
            function U(e, t) {
                ...
                "closed" === e._state ? Promise.resolve(void 0) : "errored" === e._state ? Promise.reject(e._storedError) : (W(e),
                ...
                if (void 0 !== t) {
                    if (!0 === K(t)) {
                        for (var r = 0; r < t._readRequests.length; r++) {
                            (0,
                            t._readRequests[r]._resolve)(u(void 0, !0))
                        }
                        t._readRequests = []
                    }
                    var n;
                    _(void 0 !== (n = t)._closedPromise_resolve),
                    _(void 0 !== n._closedPromise_reject),
                    n._closedPromise_resolve(void 0),
                    n._closedPromise_resolve = void 0,
                    n._closedPromise_reject = void 0
                }
            ...
            function B(e, t) {
                _(!0 === N(e), "stream must be ReadableStream"),
            ...
            function z(e, t, r) {
                var n = e._reader;
                _(0 < n._readRequests.length),
                n._readRequests.shift()._resolve(u(t, r))
            }
            function G(e) {
            ...
            e.exports = {
                ...
                IsReadableStreamDisturbed: function(e) {
                    return _(!0 === N(e), "IsReadableStreamDisturbed should only be used on known readable streams"),
                    e._disturbed
                },
            ...
            var V = function() {
                ...
                return n(t, [{
                    ...
                    value: function() {
                        ...
                        if (void 0 !== this._ownerReadableStream) {
                            if (0 < this._readRequests.length)
              ...
              , J = function() {
                function t(e) {
                    ...
                    if (!1 === de(e._readableStreamController))
                ...
                return n(t, [{
                    ...
                    key: "read",
                    value: function(e) {
                        return Q(this) ? void 0 === this._ownerReadableStream ? Promise.reject(Te("read from")) : ArrayBuffer.isView(e) ? 0 === e.byteLength ? Promise.reject(new TypeError("view must have non-zero byteLength")) : function(e, t) {
                        ...
                        }(this, e) : Promise.reject(new TypeError("view must be an array buffer view")) : Promise.reject(Le("read"))
                    }
                }, {
                    key: "releaseLock",
                    value: function() {
                        ...
                        if (void 0 !== this._ownerReadableStream) {
                            if (0 < this._readIntoRequests.length)
                                throw new TypeError("Tried to release a reader lock when that reader has pending read() calls un-settled");
                            ee(this)
                        }
                    }
            ...
            function Z(e, t) {
                ...
                "readable" === t._state ? (a = e)._closedPromise = new Promise(function(e, t) {
                    a._closedPromise_resolve = e,
                    a._closedPromise_reject = t
                }
                ) : "closed" === t._state ? ((i = e)._closedPromise = Promise.resolve(void 0),
                i._closedPromise_resolve = void 0,
                i._closedPromise_reject = void 0) : (_("errored" === t._state, "state must be errored"),
                r = e,
                n = t._storedError,
                r._closedPromise = Promise.reject(n),
                r._closedPromise_resolve = void 0,
            ...
            function ee(e) {
                ...
                "readable" === e._ownerReadableStream._state ? Ie(e, new TypeError("Reader was released and can no longer be used to monitor the stream's closedness")) : (t = e,
            ...
            function te(e) {
                ...
                return _(void 0 !== t),
                t._disturbed = !0,
                "closed" === t._state ? Promise.resolve(u(void 0, !0)) : "errored" === t._state ? Promise.reject(t._storedError) : (_("readable" === t._state),
            ...
            var re = function() {
                ...
                return n(o, [{
                    ...
                    value: function(e) {
                        return P(this),
                        h(this._underlyingSource, "cancel", [e])
                    }
                }, {
                    key: "__pullSteps",
                    value: function() {
                        ...
                        if (0 < this._queue.length) {
                            var t = S(this);
                            return !0 === this._closeRequested && 0 === this._queue.length ? W(e) : ie(this),
                            Promise.resolve(u(t, !1))
                        }
                        var r = q(e);
                        return ie(this),
                        r
            ...
            function ie(t) {
                !1 !== function(e) {
                    ...
                    if (0 < ce(e))
                        return !0;
                    return !1
                }(t) && (!0 !== t._pulling ? (_(!1 === t._pullAgain),
                t._pulling = !0,
                h(t._underlyingSource, "pull", [t]).then(function() {
                    if (!(t._pulling = !1) === t._pullAgain)
                        return t._pullAgain = !1,
                        ie(t)
                }, function(e) {
                    le(t, e)
                }).catch(y)) : t._pullAgain = !0)
            }
            function ae(e) {
                var t = e._controlledReadableStream;
                ...
                _("readable" === t._state),
                e._closeRequested = !0,
                0 === e._queue.length && W(t)
            }
            function se(t, e) {
                var r = t._controlledReadableStream;
                if (_(!1 === t._closeRequested),
                _("readable" === r._state),
                !0 === M(r) && 0 < H(r))
                    z(r, e, !1);
                else {
            ...
            var ue = function() {
              ...
              , he = function() {
                function s(t, e, r) {
                    ...
                    if (void 0 !== n && (!1 === Number.isInteger(n) || n <= 0))
                ...
                return n(s, [{
                    ...
                    value: function() {
                        ...
                        !function(e) {
                            var t = e._controlledReadableStream;
                            if (_(!1 === e._closeRequested),
                            _("readable" === t._state),
                            0 < e._queueTotalSize)
                                return e._closeRequested = !0;
                            if (0 < e._pendingPullIntos.length) {
                                var r = e._pendingPullIntos[0];
                                if (0 < r.bytesFilled) {
                    ...
                    value: function(e) {
                        ...
                        !function(e, t) {
                            ...
                            if (!0 === Y(r))
                                ...
                                !0 === X(r) ? (be(e, s, i, a),
                                we(e)) : (_(!1 === M(r), "stream must not be locked"),
                                be(e, s, i, a))
                        }(this, e)
                    }
                }, {
                    ...
                    value: function(e) {
                        ...
                        return P(this),
                        h(this._underlyingByteSource, "cancel", [e])
                    }
                }, {
                    key: "__pullSteps",
                    value: function() {
            ...
            function pe(t) {
                ...
                t._pulling = !0,
                h(t._underlyingByteSource, "pull", [t]).then(function() {
                    !(t._pulling = !1) === t._pullAgain && (t._pullAgain = !1,
                    pe(t))
                }, function(e) {
            ...
            function ge(e, t) {
                ...
                var r = !1;
                "closed" === e._state && (_(0 === t.bytesFilled),
                r = !0);
                var n, i, a, s = ve(t);
                "default" === t.readerType ? z(e, s, r) : (_("byob" === t.readerType),
                n = s,
                i = r,
                a = e._reader,
                _(0 < a._readIntoRequests.length),
                a._readIntoRequests.shift()._resolve(u(n, i)))
            }
            function ve(e) {
                var t = e.bytesFilled
                  , r = e.elementSize;
                return _(t <= e.byteLength),
                _(t % r == 0),
            ...
            function _e(e, t) {
                var r = t.elementSize
                  ...
                  , o = i
                  , l = !1;
                n < s && (o = s - t.bytesFilled,
                l = !0);
                for (var c = e._queue; 0 < o; ) {
                    var u = c[0]
                      , h = Math.min(o, u.byteLength)
                      , d = t.byteOffset + t.bytesFilled;
                    f(t.buffer, d, u.buffer, u.byteOffset, h),
                    u.byteLength === h ? c.shift() : (u.byteOffset += h,
                    u.byteLength -= h),
                    e._queueTotalSize -= h,
                    ye(e, h, t),
                    o -= h
                }
                return !1 === l && (_(0 === e._queueTotalSize, "queue must be empty"),
                _(0 < t.bytesFilled),
                _(t.bytesFilled < t.elementSize)),
                l
            }
            function ye(e, t, r) {
                _(0 === e._pendingPullIntos.length || e._pendingPullIntos[0] === r),
                Se(e),
                r.bytesFilled += t
            }
            function Ae(e) {
                _("readable" === e._controlledReadableStream._state),
                0 === e._queueTotalSize && !0 === e._closeRequested ? W(e._controlledReadableStream) : pe(e)
            }
            function Se(e) {
        ...
        , function(e, t, r) {
            ...
            function y(t, e) {
                ...
                if (!0 === t._readableClosed)
                    throw new TypeError("Readable side is already closed");
                var r = t._readableController;
                try {
                    p(r, e)
                } catch (e) {
                    throw t._readableClosed = !0,
                    S(t, e),
                    t._storedError
                }
            ...
            function P(e) {
                return h(void 0 !== e._backpressureChangePromise, "_backpressureChangePromise should have been initialized"),
                !1 === e._backpressure ? Promise.resolve() : (h(!0 === e._backpressure, "_backpressure should have been initialized"),
            ...
            function R(e, t) {
                return y(t._controlledTransformStream, e),
                Promise.resolve()
            }
            function k(e) {
            ...
            var T = function() {
                ...
                return n(r, [{
                    ...
                    value: function(e) {
                        return function(t, e) {
                            ...
                            return a(r, "transform", [e, n], R, [e, n]).then(function() {
                                return t._transforming = !1,
                                P(t)
                            }, function(e) {
                                return S(t, e),
                                Promise.reject(e)
                    ...
                    value: function() {
                        var t = this._transformStream;
                        return h(!1 === t._transforming),
                        t._writableDone = !0,
                        s(t._transformer, "flush", [t._transformStreamController]).then(function() {
                            return !0 === t._errored ? Promise.reject(t._storedError) : (!1 === t._readableClosed && A(t),
                            Promise.resolve())
                        }).catch(function(e) {
                            return S(t, e),
              ...
              , E = function() {
                ...
                return n(r, [{
                    ...
                    value: function(e) {
                        ...
                        this._startPromise.then(function() {
                            return h(void 0 !== t._backpressureChangePromise, "_backpressureChangePromise should have been initialized"),
                            !0 === t._backpressure ? Promise.resolve() : (h(!1 === t._backpressure, "_backpressure should have been initialized"),
                    ...
                    value: function() {
                        var e = this._transformStream;
                        return h(!0 === e._backpressure, "pull() should be never called while _backpressure is false"),
              ...
              , L = function() {
                function c() {
                    ...
                    var s = new T(this,i);
                    this._writable = new b(s,r),
                    h(void 0 !== this._writableController),
                    h(void 0 !== this._readableController),
                    C(this, g(this._readableController) <= 0);
                    var o = this
                      , l = d(e, "start", [o._transformStreamController]);
                    n(l),
                    i.catch(function(e) {
                        !1 === o._errored && (o._errored = !0,
                        o._storedError = e)
                    })
                }
                return n(c, [{
    ...
    , function(e, t, r) {
        ...
        function l(o) {
            o.mozCurrentTransform || (o._originalSave = o.save,
            ...
            o.transform = function(e, t, r, n, i, a) {
                ...
                this._transformMatrix = [s[0] * e + s[2] * t, s[1] * e + s[3] * t, s[0] * r + s[2] * n, s[1] * r + s[3] * n, s[0] * i + s[2] * a + s[4], s[1] * i + s[3] * a + s[5]],
                o._originalTransform(e, t, r, n, i, a)
            }
            ,
            o.setTransform = function(e, t, r, n, i, a) {
                this._transformMatrix = [e, t, r, n, i, a],
                o._originalSetTransform(e, t, r, n, i, a)
            }
            ,
            o.rotate = function(e) {
                var t = Math.cos(e)
          ...
          , n = function() {
            ...
            function y(e, t) {
                if ("undefined" != typeof ImageData && t instanceof ImageData)
                    ...
                    var r, n, i, a, s, o = t.height, l = t.width, c = o % 16, u = (o - c) / 16, h = 0 === c ? u : u + 1, d = e.createImageData(l, 16), f = 0, p = t.data, m = d.data;
                    if (t.kind === N.ImageKind.GRAYSCALE_1BPP) {
                        ...
                        for (s = 16 * l * 4,
                        n = i = 0; n < u; n++)
                            m.set(p.subarray(f, f + s)),
                            f += s,
                            e.putImageData(d, 0, i),
                            i += 16;
                        n < h && (s = l * c * 4,
                        m.set(p.subarray(f, f + s)),
                        e.putImageData(d, 0, i))
            ...
            function r(e, t, r) {
                ...
                if (!t.transferMap && o.WebGLUtils.isEnabled) {
                    var s = o.WebGLUtils.composeSMask(r.canvas, n, {
                        subtype: t.subtype,
                        backdrop: a
                    });
                ...
                !function(e, t, r, n, i, a, s) {
                    var o, l = !!a, c = l ? a[0] : 0, u = l ? a[1] : 0, h = l ? a[2] : 0;
                    o = "Luminosity" === i ? _ : b;
            ...
            for (var a in s.prototype = {
                ...
                suspendSMaskGroup: function() {
                    ...
                    r(this.ctx, this.current.activeSMask, e),
                    this.ctx.restore(),
                    this.ctx.save(),
                    p(e, this.ctx),
                ...
                setFont: function(e, t) {
                    ...
                    if (n.fontMatrix = r.fontMatrix ? r.fontMatrix : N.FONT_IDENTITY_MATRIX,
                ...
                paintChar: function(e, t, r) {
                    var n, i = this.ctx, a = this.current, s = a.font, o = a.textRenderingMode, l = a.fontSize / a.fontSizeScale, c = o & N.TextRenderingMode.FILL_STROKE_MASK, u = !!(o & N.TextRenderingMode.ADD_TO_PATH_FLAG);
                    ...
                    i.restore()) : (c !== N.TextRenderingMode.FILL && c !== N.TextRenderingMode.FILL_STROKE || i.fillText(e, t, r),
                    c !== N.TextRenderingMode.STROKE && c !== N.TextRenderingMode.FILL_STROKE || i.strokeText(e, t, r)),
                ...
                showText: function(e) {
                    ...
                    if (0 !== n) {
                        ...
                        t.patternFill && (i.fillStyle = t.fillColor.getPattern(i, this)),
                        0 < l ? i.scale(c, -1) : i.scale(c, 1);
                        var g = t.lineWidth
                          , v = t.textMatrixScale;
                        if (0 === v || 0 === g) {
                            var b = t.textRenderingMode & N.TextRenderingMode.FILL_STROKE_MASK;
                            b !== N.TextRenderingMode.STROKE && b !== N.TextRenderingMode.FILL_STROKE || (this.cachedGetSinglePixelWidth = null,
                            g = .65 * this.getSinglePixelWidth())
                        } else
                            g /= v;
                        1 !== a && (i.scale(a, a),
                        g /= a),
                        ...
                        for (_ = 0; _ < u; ++_) {
                            ...
                            N.isNum)(A))
                                ...
                                var S, w, P, C, R, k, x, T = !1, E = (A.isSpace ? o : 0) + s, I = A.fontChar, L = A.accent, D = A.width;
                                if (h)
                                    R = A.vmetric || f,
                                    k = -(k = A.vmetric ? R[1] : .5 * D) * p,
                                    x = R[2] * p,
                                    D = R ? -R[0] : D,
                                    S = k / a,
                                    w = (y + x) / a;
                                ...
                                (A.isInFont || r.missingFile) && (m && !L ? i.fillText(I, S, w) : (this.paintChar(I, S, w),
                                L && (P = S + L.offset.x / a,
                                C = w - L.offset.y / a,
                                this.paintChar(L.fontChar, P, C)))),
                                y += D * p + E * l,
                                T && i.restore()
                            }
                        }
                ...
                showType3Text: function(e) {
                    var t, r, n, i, a = this.ctx, s = this.current, o = s.font, l = s.fontSize, c = s.fontDirection, u = o.vertical ? 1 : -1, h = s.charSpacing, d = s.wordSpacing, f = s.textHScale * c, p = s.fontMatrix || N.FONT_IDENTITY_MATRIX, m = e.length;
                ...
                paintFormXObjectBegin: function(e, t) {
                    ...
                    (0,
                    N.isArray)(e) && 6 === e.length && this.transform.apply(this, e),
                    this.baseTransform = this.ctx.mozCurrentTransform,
                    (0,
                    N.isArray)(t) && 4 === t.length) {
                        var r = t[2] - t[0]
                          , n = t[3] - t[1];
                ...
                paintImageMaskXObject: function(e) {
                    ...
                    if (s && void 0 === s.compiled && (s.compiled = r <= 1e3 && n <= 1e3 ? function(e) {
                        var t, r, n, i, s = e.width, o = e.height, a = s + 1, l = new Uint8Array(a * (o + 1)), c = new Uint8Array([0, 2, 4, 0, 1, 0, 5, 4, 8, 10, 0, 8, 0, 2, 1, 0]), u = s + 7 & -8, h = e.data, d = new Uint8Array(u * o), f = 0;
                        for (t = 0,
                        i = h.length; t < i; t++)
                            for (var p = 128, m = h[t]; 0 < p; )
                                d[f++] = m & p ? 0 : 255,
                                p >>= 1;
                        var g = 0;
                        for ((f = 0) !== d[f] && (l[0] = 1,
                        ...
                        t = 1; t < o; t++) {
                            n = t * a,
                            d[(f = t * u) - u] !== d[f] && (l[n] = d[f] ? 1 : 8,
                            ++g);
                            var v = (d[f] ? 4 : 0) + (d[f - u] ? 8 : 0);
                            for (r = 1; r < s; r++)
                                c[v = (v >> 2) + (d[f + 1] ? 4 : 0) + (d[f - u + 1] ? 8 : 0)] && (l[n + r] = c[v],
                                ++g),
                                f++;
                            if (d[f - u] !== d[f] && (l[n + r] = d[f] ? 2 : 4,
                            ++g),
                            1e3 < g)
                                return null
                        }
                        ...
                        var b = new Int32Array([0, a, -1, 0, -a, 0, 0, 0, 1])
                          , _ = [];
                        for (t = 0; g && t <= o; t++) {
                            for (var y = t * a, A = y + s; y < A && !l[y]; )
                                y++;
                            if (y !== A) {
                                var S, w = [y % a, t], P = l[y], C = y;
                                do {
                                    for (var R = b[P]; !l[y += R]; )
                                        ;
                                    5 !== (S = l[y]) && 10 !== S ? (P = S,
                    ...
                    s && s.compiled)
                        ...
                        l.fillStyle = a ? i.getPattern(l, this) : i,
                        l.fillRect(0, 0, r, n),
                        l.restore(),
                ...
                paintImageMaskXObjectRepeat: function(e, t, r, n) {
                    ...
                    c.fillStyle = o ? s.getPattern(c, this) : s,
                    c.fillRect(0, 0, i, a),
                    c.restore();
                    for (var u = this.ctx, h = 0, d = n.length; h < d; h += 2)
                        u.save(),
                        u.transform(t, 0, 0, r, n[h], n[h + 1]),
                        u.scale(1, -1),
                        u.drawImage(l.canvas, 0, 0, i, a, 0, -1, 1, 1),
                        u.restore()
                },
                ...
                paintImageXObjectRepeat: function(e, t, r, n) {
                    ...
                    if (i) {
                        for (var a = i.width, s = i.height, o = [], l = 0, c = n.length; l < c; l += 2)
                            o.push({
                ...
                paintInlineImageXObject: function(e) {
                    ...
                    this.save(),
                    n.scale(1 / t, -1 / r);
                    var i, a, s = n.mozCurrentTransformInverse, o = s[0], l = s[1], c = Math.max(Math.sqrt(o * o + l * l), 1), u = s[2], h = s[3], d = Math.max(Math.sqrt(u * u + h * h), 1);
                    ...
                    if (n.drawImage(i, 0, 0, p, m, 0, -r, t, r),
                    this.imageLayer) {
                ...
                consumePath: function() {
                    var e = this.ctx;
                    this.pendingClip && (this.pendingClip === i ? e.clip("evenodd") : e.clip(),
                    this.pendingClip = null),
                    e.beginPath()
                },
    ...
    , function(e, t, r) {
        ...
        f.prototype = {
            insertRule: function(e) {
                ...
                t || ((t = this.styleElement = document.createElement("style")).id = "PDFJS_FONT_STYLE_TAG_" + this.docId,
        ...
        f.prototype.bind = function(e, t) {
            for (var r = [], n = [], i = [], a = function(t) {
                return t.loaded.catch(function(e) {
                    (0,
                    v.warn)('Failed to load font "' + t.family + '": ' + e)
                })
            }, s = f.isFontLoadingAPISupported && !f.isSyncFontLoadingSupported, o = 0, l = e.length; o < l; o++) {
                var c = e[o];
            ...
            s ? Promise.all(i).then(function() {
                d.complete()
            }) : 0 < r.length && !f.isSyncFontLoadingSupported ? this.prepareFontLoadEvent(r, n, d) : d.complete()
        }
        ,
        f.prototype.queueLoadingCallback = function(e) {
            var t = this.loadingContext
              , r = {
                ...
                complete: function() {
                    for ((0,
                    v.assert)(!r.end, "completeRequest() cannot be called twice"),
                    r.end = Date.now(); 0 < t.requests.length && t.requests[0].end; ) {
        ...
        f.prototype.prepareFontLoadEvent = function(e, t, r) {
            ...
            var a, s, o = document.createElement("canvas");
            o.width = 1,
            o.height = 1;
            ...
            for (a = 0,
            s = u.length - 3; a < s; a += 4)
                d = d - 1482184792 + n(u, a) | 0;
            a < u.length && (d = d - 1482184792 + n(u + "XXX", a) | 0),
            h = i(h, 16, 4, (0,
            v.string32)(d));
            ...
            for (a = 0,
            s = t.length; a < s; a++)
                p.push(t[a].loadedName);
            p.push(u);
            var m = document.createElement("div");
            for (m.setAttribute("style", "visibility: hidden;width: 10px; height: 10px;position: absolute; top: 0px; left: 0px;"),
            a = 0,
            s = p.length; a < s; ++a) {
                var g = document.createElement("span");
                g.textContent = "Hi",
                g.style.fontFamily = p[a],
                m.appendChild(g)
            }
            ...
            function e(t, r) {
                if (30 < ++c)
                    return (0,
                    v.warn)("Load test font never loaded."),
                    void r();
                l.font = "30px " + t,
                l.fillText(".", 0, 20),
                0 < l.getImageData(0, 0, 1, 1).data[3] ? r() : setTimeout(e.bind(null, t, r))
            }(u, function() {
        ...
        Object.defineProperty(f, "isSyncFontLoadingSupported", {
            get: function() {
                return (0,
                v.shadow)(f, "isSyncFontLoadingSupported", function() {
        ...
        var l = {
            get value() {
                return (0,
                v.shadow)(this, "value", (0,
                v.isEvalSupported)())
            }
        }
          , n = function() {
            function e(e, t) {
                for (var r in this.compiledGlyphs = Object.create(null),
                e)
                    this[r] = e[r];
                this.options = t
            }
            return e.prototype = {
                ...
                createFontFaceRule: function() {
                    ...
                    if (this.options.disableFontFace)
                        ...
                        null;
                    var e = (0,
                    v.bytesToString)(new Uint8Array(this.data))
                      , t = this.loadedName
                      , r = "url(data:" + this.mimetype + ";base64," + btoa(e) + ");"
                      , n = '@font-face { font-family:"' + t + '";src:' + r + "}";
                    return this.options.fontRegistry && this.options.fontRegistry.registerFont(this, r),
                    n
                },
                getPathGenerator: function(e, t) {
                    if (!(t in this.compiledGlyphs)) {
                        ...
                        if (this.options.isEvalSupported && l.value) {
                            ...
                            for (n = 0,
                            i = a.length; n < i; n++)
                                s = void 0 !== (r = a[n]).args ? r.args.join(",") : "",
                                o += "c." + r.cmd + "(" + s + ");\n";
        ...
        var P = r(0)
          ...
          , d = function() {
            function d(e, t, r, n, i, a, s, o) {
                var l, c = t.coords, u = t.colors, h = e.data, d = 4 * e.width;
                c[r + 1] > c[n + 1] && (l = r,
                r = n,
                n = l,
                l = a,
                ...
                if (!(b <= p))
                    for (var _, y, A, S, w, P, C, R, k, x = u[a], T = u[a + 1], E = u[a + 2], I = u[s], L = u[s + 1], D = u[s + 2], O = u[o], F = u[o + 1], N = u[o + 2], M = Math.round(p), j = Math.round(b), q = M; q <= j; q++) {
                        q < g ? (_ = f - (f - m) * (k = q < p ? 0 : p === g ? 1 : (p - q) / (p - g)),
                        y = x - (x - I) * k,
                        A = T - (T - L) * k,
                        S = E - (E - D) * k) : (_ = m - (m - v) * (k = b < q ? 1 : g === b ? 0 : (g - q) / (g - b)),
                        y = I - (I - O) * k,
                        A = L - (L - F) * k,
                        S = D - (D - N) * k),
            ...
            function C(e, t, r) {
                ...
                case "lattice":
                    var o = t.verticesPerRow
                      ...
                      , c = o - 1;
                    for (n = 0; n < l; n++)
                        for (var u = n * o, h = 0; h < c; h++,
                        u++)
                            d(e, r, a[u], a[u + 1], a[u + o], s[u], s[u + 1], s[u + o]),
                            d(e, r, a[u + o + 1], a[u + 1], a[u + o], s[u + o + 1], s[u + 1], s[u + o]);
                    break;
                case "triangles":
                    for (n = 0,
                    i = a.length; n < i; n += 3)
                        d(e, r, a[n], a[n + 1], a[n + 2], s[n], s[n + 1], s[n + 2]);
                    break;
                default:
            ...
            return function(e, t, r, n, i, a, s) {
                var o, l, c, u, h = Math.floor(e[0]), d = Math.floor(e[1]), f = Math.ceil(e[2]) - h, p = Math.ceil(e[3]) - d, m = Math.min(Math.ceil(Math.abs(f * t[0] * 1.1)), 3e3), g = Math.min(Math.ceil(Math.abs(p * t[1] * 1.1)), 3e3), v = f / m, b = p / g, _ = {
                    coords: r,
                    colors: n,
                    offsetX: -h,
                    offsetY: -d,
                ...
                if (R.WebGLUtils.isEnabled)
                    o = R.WebGLUtils.drawFigures(m, g, a, i, _),
                    (l = s.getCanvas("mesh", y, A, !1)).context.drawImage(o, 2, 2),
                    o = l.canvas;
                else {
            ...
            fromIR: function(e) {
                ...
                return {
                    ...
                    getPattern: function(e, t, r) {
                        var n;
                        if (r)
                            n = P.Util.singularValueDecompose2dScale(e.mozCurrentTransform);
                        else if (n = P.Util.singularValueDecompose2dScale(t.baseTransform),
                        u) {
                            var i = P.Util.singularValueDecompose2dScale(u);
                            n = [n[0] * i[0], n[1] * i[1]]
                        }
                        var a = d(c, n, s, o, l, r ? null : h, t.cachedCanvases);
                        return r || (e.setTransform.apply(e, t.baseTransform),
        ...
        var i = function() {
            ...
            return e.prototype = {
                createPatternCanvas: function(e) {
                    ...
                    this.setFillAndStrokeStyleToContext(A, a, o),
                    this.setScale(m, g, n, i),
                    this.transformToScale(S);
                    var w = [1, 0, 0, 1, -f[0], -f[1]];
                    return S.transform.apply(S, w),
                    this.clipBbox(S, r, c, u, h, d),
        ...
        var a = r(0)
          , n = function() {
            ...
            function t(e, t) {
                ...
                (e._fullRequestReader = this).onProgress = null
            }
            function n(e, t, r) {
                this._stream = e,
                this._begin = t,
                ...
                _onReceiveData: function(t) {
                    ...
                    if (void 0 === t.begin)
                        ...
                        var e = this._rangeReaders.some(function(e) {
                            return e._begin === t.begin && (e._enqueue(r),
                            !0)
                        });
                        (0,
                        a.assert)(e)
            ...
            t.prototype = {
                _enqueue: function(e) {
                    this._done || (0 < this._requests.length ? this._requests.shift().resolve({
                        value: e,
                        done: !1
        ...
        if ("undefined" == typeof PDFJS || !PDFJS.compatibilityChecked) {
            ...
            function() {
                ...
                function r(e, t) {
                    ...
                    function(e) {
                        for (; n < e; )
                            Object.defineProperty(r.prototype, n, s(n)),
                            n++
                    }(this.length)
                }
                ...
                function o(e) {
                    ...
                    if ("number" == typeof e)
                        ...
                        n = e.length; r < n; ++r)
                            t[r] = e[r];
                    return t.subarray = i,
                    (t.buffer = t).byteLength = t.length,
                    t.set = a,
                    "object" === (void 0 === e ? "undefined" : l(e)) && e.buffer && (t.buffer = e.buffer),
                    t
                }
                c.Uint8Array = o,
                c.Int8Array = o,
            ...
            function() {
                ...
                Object.defineProperty = function(e, t, r) {
                    ...
                    "value"in r && (e.__defineSetter__(t, function(e) {
            ...
            function() {
                if (!("atob"in c)) {
                    c.atob = function(e) {
                        ...
                        for (var t, r, n = 0, i = 0, a = ""; r = e.charAt(i++); ~r && (t = n % 4 ? 64 * t + r : r,
                        n++ % 4) ? a += String.fromCharCode(255 & t >> (-2 * n & 6)) : 0)
            ...
            g && ("dataset"in document.createElement("div") || Object.defineProperty(HTMLElement.prototype, "dataset", {
                get: function() {
                    if (this._dataset)
                        return this._dataset;
                    for (var e = {}, t = 0, r = this.attributes.length; t < r; t++) {
                        var n = this.attributes[t];
                        "data-" === n.name.substring(0, 5) && (e[n.name.substring(5).replace(/\-([a-z])/g, function(e, t) {
            ...
            function() {
                ...
                if (g) {
                    if ("console"in window)
                        return "bind"in console.log || (console.log = (n = console.log,
                        function(e) {
                            return n(e)
                        }
                        ),
            ...
            function() {
                if (g)
                    if (window.CanvasPixelArray)
                        ...
                        var e, t = !1;
                        if (o ? t = (e = i.match(/Chrom(e|ium)\/([0-9]+)\./)) && parseInt(e[2]) < 21 : a ? t = s : m && (t = (e = i.match(/Version\/([0-9]+)\.([0-9]+)\.([0-9]+) Safari\//)) && parseInt(e[1]) < 6),
                        t) {
            ...
            function() {
                ...
                g && (f ? e() : "requestAnimationFrame"in window || (window.requestAnimationFrame = window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame,
                window.requestAnimationFrame || e()))
            }(),
            (f || a) && (PDFJS.maxCanvasPixels = 5242880),
            g && d && window.parent !== window && (PDFJS.disableFullscreen = !0),
            g && ("currentScript"in document || Object.defineProperty(document, "currentScript", {
                get: function() {
            ...
            function() {
                if (c.Promise)
                    return "function" != typeof c.Promise.all && (c.Promise.all = function(e) {
                        var r, n, i = 0, a = [], t = new c.Promise(function(e, t) {
                            r = e,
                            n = t
                        }
                        );
                    ...
                    "function" != typeof c.Promise.resolve && (c.Promise.resolve = function(t) {
                    ...
                    "function" != typeof c.Promise.reject && (c.Promise.reject = function(r) {
                    ...
                    "function" != typeof c.Promise.prototype.catch && (c.Promise.prototype.catch = function(e) {
                ...
                var n = {
                    ...
                    scheduleHandlers: function(e) {
                        0 !== e._status && (this.handlers = this.handlers.concat(e._handlers),
                        e._handlers = [],
                    ...
                    runHandlers: function() {
                        for (var e = Date.now() + 1; 0 < this.handlers.length; ) {
                            ...
                            try {
                                1 === r ? "function" == typeof t.onResolve && (n = t.onResolve(n)) : "function" == typeof t.onReject && (n = t.onReject(n),
                                r = 1,
                                t.thisPromise._unhandledRejection && this.removeUnhandeledRejection(t.thisPromise))
                            } catch (e) {
                                r = 2,
                                n = e
                            }
                            if (t.nextPromise._updateStatus(r, n),
                            Date.now() >= e)
                                break
                        }
                    ...
                    removeUnhandeledRejection: function(e) {
                        ...
                        for (var t = 0; t < this.unhandledRejections.length; t++)
                            this.unhandledRejections[t].promise === e && (this.unhandledRejections.splice(t),
                            t--)
                    },
                        ...
                        setTimeout(function() {
                            ...
                            for (var e = Date.now(), t = 0; t < i.unhandledRejections.length; t++)
                                if (500 < e - i.unhandledRejections[t].time) {
                                    ...
                                    i.unhandledRejections.splice(t),
                                    t--
                                }
                ...
                h.prototype = {
                    ...
                    _updateStatus: function(e, t) {
                        1 !== this._status && 2 !== this._status && (1 === e && h.isPromise(t) ? t.then(this._updateStatus.bind(this, 1), this._updateStatus.bind(this, 2)) : (this._status = e,
                        this._value = t,
                        2 === e && 0 === this._handlers.length && (this._unhandledRejection = !0,
                        n.addUnhandledRejection(this)),
                        n.scheduleHandlers(this)))
                    },
                    _resolve: function(e) {
            ...
            function() {
                ...
                if (!e) {
                    ...
                    a.prototype = {
                        ...
                        set pathname(e) {
                            ...
                            n.call(this, e, "relative path start"))
                        },
                        get search() {
                        ...
                        set hash(e) {
                            this._isInvalid || ((this._fragment = "#") === e[0] && (e = e.slice(1)),
                            n.call(this, e, "fragment"))
                        },
                        get origin() {
                            var e;
                    ...
                    var r = c.URL;
                    r && (a.createObjectURL = function(e) {
                ...
                function n(e, t, r) {
                    ...
                    var i, a, s = t || "scheme start", o = 0, l = "", c = !1, u = !1, h = [];
                    e: for (; (e[o - 1] !== S || 0 === o) && !this._isInvalid; ) {
                        ...
                        case "relative":
                            ...
                            if ("/" === d || "\\" === d)
                                ...
                                if ("#" !== d) {
                                    var f = e[o + 1]
                                      , p = e[o + 2];
                                    ("file" !== this._scheme || !w.test(d) || ":" !== f && "|" !== f || p !== S && "/" !== p && "\\" !== p && "?" !== p && "#" !== p) && (this._host = r._host,
                                    this._port = r._port,
                                    this._username = r._username,
                                    this._password = r._password,
                                    this._path = r._path.slice(),
                        ...
                        case "relative slash":
                            ...
                            "\\" === d && n("\\ is an invalid code point."),
                            s = "file" === this._scheme ? "file host" : "authority ignore slashes";
                            break;
                        ...
                        case "file host":
                            if (d === S || "/" === d || "\\" === d || "?" === d || "#" === d) {
                                2 !== l.length || !w.test(l[0]) || ":" !== l[1] && "|" !== l[1] ? (0 === l.length || (this._host = k.call(this, l),
                                l = ""),
                                s = "relative path start") : s = "relative path";
                                continue
                            }
                        ...
                        case "hostname":
                            if (":" !== d || u) {
                                ...
                                "\t" !== d && "\n" !== d && "\r" !== d ? ("[" === d ? u = !0 : "]" === d && (u = !1),
                                l += d) : n("Invalid code point in host/hostname: " + d)
                            } else if (this._host = k.call(this, l),
                            l = "",
                            s = "port",
                            "hostname" === t)
                                break e;
                        ...
                        case "relative path":
                            ...
                            if (d !== S && "/" !== d && "\\" !== d && (t || "?" !== d && "#" !== d))
                                ...
                                ".." === l ? (this._path.pop(),
                                "/" !== d && "\\" !== d && this._path.push("")) : "." === l && "/" !== d && "\\" !== d ? this._path.push("") : "." !== l && ("file" === this._scheme && 0 === this._path.length && 2 === l.length && w.test(l[0]) && "|" === l[1] && (l = l[0] + ":"),
                                this._path.push(l)),
                                l = "",
                                "?" === d ? (this._query = "?",
                                s = "query") : "#" === d && (this._fragment = "#",
                            ...
                            break;
                        case "query":
                            t || "#" !== d ? d !== S && "\t" !== d && "\n" !== d && "\r" !== d && (this._query += (void 0,
                            32 < (a = (i = d).charCodeAt(0)) && a < 127 && -1 === [34, 35, 60, 62, 96].indexOf(a) ? i : encodeURIComponent(i))) : (this._fragment = "#",
                            s = "fragment");
                            break;
                        case "fragment":
                ...
                function a(e, t) {
                    void 0 === t || t instanceof a || (t = new a(String(t))),
                    this._url = e,
                    i.call(this);
                    var r = e.replace(/^[ \t\r\n\f]+|[ \t\r\n\f]+$/g, "");
