            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 section-t8">
                        <div class="col-md-12">
                            <form action="{{ route('wisudawan.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <input type="text" name="judul"
                                                ...
                                                placeholder="Judul Skripsi" required>
                                            @error('judul')
                                                <span>{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <input type="text" name="ipk"
                                                class="form-control form-control-lg form-control-a" placeholder="IPK"
                                                required>
                                            @error('ipk')
                                                <span>{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <select name="jurusan" id="jurusan" required>
                                                @foreach (\App\Enums\Jurusan::getLabels() as $value => $label)
